...
Loading, processing and plotting the data from the John Hopkins COVID-19 database. The data is automatically read from the online repository. The data can be found here: https://github.com/CSSEGISandData/COVID-19.
